export default function useFormat(){
    ...
    const currencyNumberOnly = (amount, currency) => {
        const nAmount = amount ? Number(amount) : 0
        return nAmount.toLocaleString(currency.format, {minimumFractionDigits:currency.decimals_quantity , maximumFractionDigits: currency.decimals_quantity})
    }
    ...
    const formatDateText = (date) => {
        ...
        var d = new Date(date + (date.length == 10 ? 'T23:00:00.000Z' : '')),
